  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case CategoriesChildrenViewRow:
            return CategoriesChildrenViewRow(data);
          case ChatMessagesRow:
            return ChatMessagesRow(data);
          case GigsSavedRow:
            return GigsSavedRow(data);
          case UsersExtraRow:
            return UsersExtraRow(data);
          case GigsRow:
            return GigsRow(data);
          case OrderStatusRow:
            return OrderStatusRow(data);
          case OrderDetailsViewRow:
            return OrderDetailsViewRow(data);
          case CategoriesParentViewRow:
            return CategoriesParentViewRow(data);
          case GigDetailsViewRow:
            return GigDetailsViewRow(data);
          case GigsSavedViewRow:
            return GigsSavedViewRow(data);
          case CategoriesRow:
            return CategoriesRow(data);
          case GigTiersRow:
            return GigTiersRow(data);
          case OrdersRow:
            return OrdersRow(data);
          case GigCategoriesRow:
            return GigCategoriesRow(data);
          default:
            return null;
        }

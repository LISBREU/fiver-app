...
class FiverAppSupabaseUser extends BaseAuthUser {
  FiverAppSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> fiverAppSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = FiverAppSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
